...
public class FacebookOAuth2ProviderTest {
    ...
    void beforeEach() {
        ...
        facebookProperties.setConnection("facebook-connection");
        facebookProperties.setRedirectUri("http://localhost:3000/facebook/callback");
        facebookProperties.setScope("email profile");
    }
