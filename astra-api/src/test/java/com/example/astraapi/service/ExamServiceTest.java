...
public class ExamServiceTest {
    ...
    void shouldReturnAllBySpecializationId() {
        Mockito.when(examRepository.getAllBySpecializationIdAndStatus(ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(List.of(
                new ExamEntity(1L, "2010"),
                new ExamEntity(2L, "2011"),
                new ExamEntity(3L, "2012"),
                new ExamEntity(4L, "2013")
        ...
        List<ResponseExamDto> exams = examService.getActive(5L);
