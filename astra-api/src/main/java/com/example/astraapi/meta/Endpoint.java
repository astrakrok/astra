...
public class Endpoint {
    ...
    public static final String SPECIALIZATION_EXAMS = "/api/v1/specializations/{specializationId}/exams";
    ...
    public static final String ADMIN_TRANSFER = "/api/v1/admin/transfer";
}
